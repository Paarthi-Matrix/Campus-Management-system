...
import src.com.ideas2it.cms.service.StudentService;
import src.com.ideas2it.cms.util.DateUtil;
...
public class StudentController {
    ...
    public void addStudent() {
        ...
        } catch (StudentDatabaseException | HibernateDbConnectionException e) {
    ...
    public void deleteStudent() {
        ...
        if (student == null) {
            ...
            System.out.println("Student " + student.getStudentName() + " with roll number " + rollNumber + " is deleted successfully!");
        }
    }
    ...
    public void getStudentByGrade() {
        ...
        while (!validInput) {  /* Validate input for yes or no */
         ...
         System.out.println();
         System.out.println("===============================================");
         System.out.printf("%-15s %-15s %-15s %-15s %-15s %-15s%n", "Student ID", "Student Name", "Roll Number", "Blood Group", 
                                                                    "Date of Birth", "Age");
         System.out.println("===============================================");
